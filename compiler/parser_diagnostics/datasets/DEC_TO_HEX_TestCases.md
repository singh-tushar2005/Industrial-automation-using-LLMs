...
- **Total lines:** 597
- **PROGRAM blocks:** 1
- **FUNCTION_BLOCK blocks:** 18
- **Multiple compilation units:** yes

## AST Status

- **Status:** full_support
- **Nodes present:** ArrayIndexNode, AssignmentNode, BinaryExpressionNode, BlockNode, BooleanNode, CaseBranchNode, CaseStatementNode, CompilationUnitNode, ForLoopNode, FunctionBlockCallNode, IfStatementNode, InvocationArgumentNode, LogicalExpressionNode, MemoryMappingNode, NumberNode, ProgramNode, StringLiteralNode, TimeLiteralNode, VarBlockNode, VariableDeclarationNode, VariableNode
...
### Unsupported
- timer_TON (lines [9, 38, 67, 96, 125, 154, 183, 212, 241, 270, 299, 328, 357, 386, 415, 444, 473, 502])
