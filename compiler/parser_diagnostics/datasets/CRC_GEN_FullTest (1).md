...
- **Status:** full_support
- **Nodes present:** ArrayIndexNode, AssignmentNode, BinaryExpressionNode, BlockNode, BooleanNode, CaseBranchNode, CaseStatementNode, CompilationUnitNode, ConfigurationNode, ForLoopNode, FunctionBlockCallNode, FunctionInvocationNode, IfStatementNode, InvocationArgumentNode, LogicalExpressionNode, MemoryMappingNode, NumberNode, ProgramBindingNode, ProgramNode, ResourceNode, TaskNode, TimeLiteralNode, TypedLiteralNode, VarBlockNode, VariableDeclarationNode, VariableNode, WhileLoopNode
